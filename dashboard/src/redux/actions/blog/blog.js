...
export const get_author_blog_list = () => async dispatch => {
    console.log("get_author_blog_list", apiUrl)
    const config = {
        headers: {
    ...
    try{
        ...
        const res = await axios.get(`${apiUrl}/api/blog/author_list`, config)
...
export const get_author_blog_list_page = (page) => async dispatch => {
    ...
    try{
        ...
        const res = await axios.get(`${apiUrl}/api/blog/author_list?p=${page}`, config)
