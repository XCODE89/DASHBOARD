...
import { ClassicEditor, Bold, Essentials, Italic, Mention, Paragraph, Undo, Underline, Link, BlockQuote, Image, CodeBlock, List, Heading } from 'ckeditor5';
...
const EditPost = ({
    ...
    const onSubmit = e =>{
        ...
        const fetchData = async()=>{
            setLoading(true)
            try{
                const res = await axios.put(`${apiUrl}/api/blog/edit`,
                formData,
                config)
    ...
    const onSubmitDraft = e =>{
        ...
        const fetchData = async()=>{
            setLoading(true)
            try{
                const res = await axios.put(`${apiUrl}/api/blog/draft`,
                formData,
                config)
    ...
    const onSubmitPublish = e =>{
        ...
        const fetchData = async()=>{
            setLoading(true)
            try{
                const res = await axios.put(`${apiUrl}/api/blog/publish`,
                formData,
                config)
    ...
    const onSubmitDelete = e =>{
        ...
        const fetchData = async()=>{
            setLoading(true)
            try{
                const res = await axios.delete(`${apiUrl}/api/blog/delete/${slug}`,
                formData,
                config)
